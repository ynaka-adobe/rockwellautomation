...
/**
 * Transformer: Rockwell Automation DM/Scene7 images.
 * Converts Dynamic Media <img> tags into anchors so the DM URL survives
 * markdown round-trip. The client-side auto-block in scripts/scripts.js
 * rebuilds responsive <picture> elements from those anchors at render time.
 *
 * Runs in afterTransform only — block parsers need <img> in beforeTransform
 * to build their cells correctly.
 *
 * DM URLs detected in migration-work/metadata.json .images.mapping:
 *   e.g. https://rockwellautomation.scene7.com/is/image/rockwellautomation/...
 */
